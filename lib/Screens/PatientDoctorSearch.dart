                            ...
                            return GestureDetector(
                              ...
                              child: Padding(
                                  ...
                                  child: NearbyDoctorContainer(
                                      UID: filterData.elementAt(index).UID,
                                      name: filterData.elementAt(index).name,
                                      specialization: filterData
                                          .elementAt(index)
                                          .specialization,
                                      gender:
                                          filterData.elementAt(index).gender,
                                      experience: filterData
                                          .elementAt(index)
                                          .experience,
                                      imgURL:
                                          filterData.elementAt(index).imgURL)),
                            );
                          })
                      : ListView.builder(
                          scrollDirection: Axis.vertical,
                            ...
                            return GestureDetector(
                              ...
                              child: Padding(
                                  ...
                                  child: NearbyDoctorContainer(
                                      ...
                                      experience:
                                          data.elementAt(index).experience,
