              ...
              child: Container(
                ...
                child: Column(
                  children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextField(
                                ...
                                decoration: InputDecoration(
                                  errorText:
                                      _ageValidate ? 'Must Enter Age' : null,
                                  contentPadding: EdgeInsets.fromLTRB(
                                      20.0, 15.0, 20.0, 15.0),
                              ...
                              child: Container(
                                  ...
                                  child: Align(
                                    ...
                                    child: Text(
                                      "Male",
                                      style: GoogleFonts.montserrat(
                                          fontSize: 14, color: _gendertxtColor),
                                    ),
                                  )),
                              onTap: () {
                                setState(() {
                                  ...
                                  if (type == "doctor") {
                                    ...
                                    _imageAsset =
                                        "assets/images/femaleperson.png";
                                  }
                                });
                              },
                            ),
                              ...
                              child: Container(
                                  ...
                                  child: Align(
                                    ...
                                    child: Text(
                                      "Specialist",
                                      style: GoogleFonts.montserrat(
                                          fontSize: 14, color: _typetxtColor),
                                    ),
                                  )),
                              onTap: () {
                                setState(() {
                              ...
                              child: Container(
                                  ...
                                  child: Align(
                                    ...
                                    child: Text(
                                      "Patient",
                                      style: GoogleFonts.montserrat(
                                          fontSize: 14, color: _typetxtColor2),
                                    ),
                                  )),
                              onTap: () {
                                setState(() {
                    ...
                    GestureDetector(
                        child: PrimaryButton(
                            width: size.width, height: 50, title: "Proceed"),
                        onTap: () {
                          processData();
                        })
                  ],
      ...
      if (validateFields()) {
        if (type == "doctor") {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (builder) => CompleteDoctorProfile(
                        imageURL: imageFile,
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (builder) => CompletePatientProfile(
                        imageURL: imageFile,
                        email: _emailController.text,
                        age: _ageController.text,
                        password: _passwordController.text,
